...
| 操作 | 说明 |
|------|------|
| **右键表格行** | 显示菜单：⚡ 强制立即压缩（忽略已有产物与冷却）/ 📂 打开所在文件夹 |
